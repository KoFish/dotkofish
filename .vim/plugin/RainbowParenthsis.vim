...
hi level1c  ctermfg=232 guifg=DarkSlateBlue
hi level2c  ctermfg=233 guifg=RoyalBlue
hi level3c  ctermfg=234 guifg=DarkSlateGray
hi level4c  ctermfg=235 guifg=DarkGreen
hi level5c  ctermfg=236 guifg=OliveDrab
hi level6c  ctermfg=237 guifg=LimeGreen
hi level7c  ctermfg=238 guifg=GreenYellow
hi level8c  ctermfg=239 guifg=yellow
hi level9c  ctermfg=240 guifg=gold
hi level10c ctermfg=241 guifg=orange
hi level11c ctermfg=242 guifg=chocolate
hi level12c ctermfg=243 guifg=red
hi level13c ctermfg=245 guifg=brown
hi level14c ctermfg=246 guifg=tomato
hi level15c ctermfg=247 guifg=LightSalmon
hi level16c ctermfg=248 guifg=white
