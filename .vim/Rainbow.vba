...
"  call Decho("enabling () rainbow for C++")
  syn region	cCppParen	transparent matchgroup=hlLevel0	start='(' skip='\\$' excludenl end=')' end='$' 			 contains=@cCppParenGroup,cCppParen1 
